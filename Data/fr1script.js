...
{    n_arr[i] = n_arr[i].replaceAll(" ","");
   ...
   else
   {
    ...
    { 
      ...
      data=data+`<div style='position:absolute; top: 10px; left:230px; width: 230px; height: 235px; overflow:auto'>Name : ${name[e]}<br><br>Age : ${content[name[e]].Age}<br><br>Gender : ${content[name[e]].Gender}<br><br>`;
